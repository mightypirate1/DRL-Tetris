...
from agents.sherlock_agent.sherlock_agent_trainer_base import sherlock_agent_trainer_base

class sherlock_agent_ppo_trainer(sherlock_agent_trainer_base):
    def do_training(self, sample=None, policy=None):
        ...
        actions, pieces, probabilities, advantages, target_values, deltas, delta_sums = _actions
        ...
        for t in range(n_epochs):
            ...
            for i in range(0,n,minibatch_size):
                stats, _ = model.train(
                                         ...
                                         deltas[perm[i:i+minibatch_size]],
                                         delta_sums[perm[i:i+minibatch_size]],
