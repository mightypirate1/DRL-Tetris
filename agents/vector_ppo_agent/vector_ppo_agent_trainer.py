...
class vector_ppo_agent_trainer(vector_ppo_agent_base):
    def __init__(
                 self,
        ...
        vector_ppo_agent_base.__init__(self, id=id, name="trainer{}".format(id), session=session, sandbox=sandbox, settings=settings, mode=mode)
        ...
        for model in models:
            ...
            self.experience_replay_dict[model] = experience_replay(
                                                                    ...
                                                                    action_size=4, #rotation, translation, piece and probability
