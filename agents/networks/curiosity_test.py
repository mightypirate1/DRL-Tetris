...
class value_net:
    def __init__(self, agent_id, name, state_size, sess, settings=None, output_activation=tf.nn.tanh):
    ...
    def train(self, input_states, target_values, lr=10**-6, weights=None):
        if weights is None:
