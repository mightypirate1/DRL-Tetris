...
struct PythonHandle {
    ...
    void action_make(int player, int action);
    bool action_finish(int player);

    bool make_actions(std::vector<std::vector<int>> actions);
    bool finish_actions(int time_elapsed);
...
PYBIND11_MODULE(TETRIS_MODULE_NAME, m) {
    ...
    m.def("set_pieces", [&](std::array<uint8_t, 7> a) {
        ...
        for (auto v : a)
            if (v != 2 && v != 3) GamePlay::only_zs = false;
    });

    pybind11::class_<BasicField>(m, "BasicField")
        .def(pybind11::pickle([](const BasicField& g) { return pybind11::make_tuple(g.square, g.piece, g.width, g.height); },
                              [](pybind11::tuple t) {
                                  auto ret = BasicField();
    ...
    pybind11::class_<TestField>(m, "TestField")
        .def(pybind11::pickle([](const TestField& g) { return pybind11::make_tuple(g.test_path, g.mask, g.current_column, g.finesseMove); },
                              [](pybind11::tuple t) {
                                  auto ret = TestField();
    ...
    pybind11::class_<MoveInfo>(m, "MoveInfo")
        .def(pybind11::pickle([](const MoveInfo& g) { return pybind11::make_tuple(g.posX, g.rot, g.path, g.use_path, g.score); },
                              [](pybind11::tuple t) {
                                  auto ret = MoveInfo();
    ...
    pybind11::class_<basePieces>(m, "basePieces")
        .def(pybind11::pickle([](const basePieces& g) { return pybind11::make_tuple(g.grid, g.rotation, g.current_rotation, g.posX, g.posY, g.lpiece, g.tile, g.piece); },
                              [](pybind11::tuple t) {
                                  auto ret = basePieces();
    ...
    pybind11::class_<randomizer>(m, "randomizer")
        .def(pybind11::pickle([](const randomizer&) { return pybind11::make_tuple(0); }, [](pybind11::tuple) { return randomizer(); }))
        .def(pybind11::init<>());
    // :)

    pybind11::class_<GameplayData>(m, "GameplayData")
        .def(pybind11::pickle(
            [](const GameplayData& g) {
                return pybind11::make_tuple(g.linesSent, g.linesRecieved, g.bpm, g.garbageCleared, g.linesCleared, g.pieceCount, g.linesBlocked, g.maxCombo,
                                            g.roundDuration);
            },
            [](pybind11::tuple t) {
    ...
    pybind11::class_<GarbageHandler>(m, "GarbageHandler")
        .def(pybind11::pickle([](const GarbageHandler& g) { return pybind11::make_tuple(g.garbage, g.minRemaining, g.addDelay); },
                              [](pybind11::tuple t) {
    ...
    pybind11::class_<Garbage>(m, "Garbage")
        .def(pybind11::pickle([](const Garbage& g) { return pybind11::make_tuple(g.count, g.delay); },
                              [](pybind11::tuple t) { return Garbage(t[0].cast<short>(), t[1].cast<int32_t>()); }));
    // .def(pybind11::init<>());
    // :)

    pybind11::class_<ComboCounter>(m, "ComboCounter")
        .def(pybind11::pickle([](const ComboCounter& g) { return pybind11::make_tuple(g.maxCombo, g.comboCount, g.remaining); },
                              [](pybind11::tuple t) {
    ...
    pybind11::class_<DropDelay>(m, "DropDelay")
        .def(pybind11::pickle(
            [](const DropDelay& g) {
                return pybind11::make_tuple(g.dropDelay, g.dropDelayTime, g.increaseDropDelay, g.increaseDropDelayTime, g.lockdownTime, g.lockdown);
            },
            [](pybind11::tuple t) {
                auto ret = DropDelay();
    ...
    pybind11::class_<GamePlay>(m, "GamePlay")
        .def(pybind11::pickle(
            [](const GamePlay& g) {
                return pybind11::make_tuple(g.field, g.testField, g.basepiece, g.rander, g.data, g.garbage, g.combo, g.dropDelay, g.nextpiece, g.incoming_lines,
                                            g.incoming_lines_count, g.time_ms, g.linesCleared, g.reward, g.dead);
            },
            [](pybind11::tuple t) {
                auto ret = GamePlay();
    ...
    pybind11::class_<PythonHandle>(m, "PythonHandle")
        .def(pybind11::pickle(
            [](const PythonHandle& p) {
                return pybind11::make_tuple(p.players, p.round_over, p.check_for_winner, p.players.size(), p.masks, p.last_winner, FIELD_WIDTH, FIELD_HEIGHT,
                                            GamePlay::randomizer_map, GamePlay::only_zs);
            },
            [](pybind11::tuple t) {
                PythonHandle ret;
    ...
    pybind11::class_<Mask>(m, "Mask")
        ...
        .def(pybind11::pickle([](const Mask&) { return pybind11::make_tuple(0); }, [](pybind11::tuple) { return Mask(); }));
